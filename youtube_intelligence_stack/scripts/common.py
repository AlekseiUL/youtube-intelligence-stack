...
def normalize_video_record(
    ...
    *,
    ...
    return {
        ...
        "published_at": first_non_empty(raw.get("published_at"), parse_timestamp(raw.get("timestamp")), parse_upload_date(raw.get("upload_date"))),
        "duration": first_non_empty(raw.get("duration_string"), raw.get("duration")),
        "views": first_non_empty(raw.get("view_count"), raw.get("views_count"), raw.get("views"), 0),
        "comments_count": first_non_empty(raw.get("comment_count"), raw.get("comments_count"), 0),
